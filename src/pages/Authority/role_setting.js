      ...
      <FormItem labelCol={{ span: 6 }} wrapperCol={{ span: 15 }} label="角色名称">
        {form.getFieldDecorator("name", {
          ...
          rules: [{
            ...
            pattern: /^[A-Za-z0-9-_\u4e00-\u9fa5]{2,10}$/,
            message: "命名规则为中/英文开头可含数字，特殊符号只能包含_-，长度为2-10位"
          }]
      ...
      <FormItem labelCol={{ span: 6 }} wrapperCol={{ span: 15 }} label="角色描述">
        {form.getFieldDecorator("description", {
          ...
          rules: [{
            ...
            message: "角色描述为中英文不包含任何特殊符号,长度为2-20位"
          }]
...
class roleSetting extends Component {
  ...
  * */
  ...
  refreshTable = (isFirstPage, params) => {
    ...
    let pageSize = authority.roleData.data.pagination.pageSize,
  ...
  * */
  ...
  tableSearch = (e) => {
    ...
    form.validateFields((err, fieldValue) => {
      ...
      this.refreshTable(true, fieldValue);// 刷新表格
    });
  };
